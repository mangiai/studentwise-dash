...
const findRouteRules = /* @__PURE__ */ (() => {
  const $0 = [{ name: "headers", route: "/assets/**", handler: headers, options: { "cache-control": "public, max-age=31536000, immutable" } }], $1 = [{ name: "headers", route: "/**", handler: headers, options: { "cache-control": "no-store, no-cache, must-revalidate" } }];
  return (m, p) => {
    let r = [];
...
const _lazy_RnU12q = defineLazyEventHandler(() => import("./_chunks/ssr-renderer.mjs"));
const findRoute = /* @__PURE__ */ (() => {
  const data = { route: "/**", handler: _lazy_RnU12q };
  return ((_m, p) => {
